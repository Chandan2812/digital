...
exports.sendOTP = async (req, res) => {
  try {
    ...
    await sendEmail({
      to: email,
      subject: "Your Bigwig Media Verification Code",
      html: `
    ...
    <table align="center" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e5e7eb;">
      ...
      <tr>
        <td align="center" style="background:#ffffff;padding:35px 20px 20px;">
          <h1 style="margin:0;color:#111827;font-size:30px;">Bigwig Media</h1>
        </td>
      </tr>

      <!-- Green Line -->
      <tr>
        <td style="height:5px;background:#F5C542;"></td>
      </tr>
      ...
      <tr>
        <td style="padding:40px 35px;color:#333333;">
          ...
          <p style="margin:0 0 20px;font-size:16px;line-height:1.7;color:#4b5563;">
            Thank you for contacting <strong>Bigwig Media</strong>.
            Please use the verification code below to confirm your email and submit your inquiry.
          </p>
          ...
          <p style="margin:0;font-size:13px;color:#6b7280;line-height:1.8;">
            ...
            <strong>Bigwig Media</strong><br/>
            Digital marketing, creative campaigns and growth strategy.
          </p>
      ...
      <tr>
        <td align="center" style="background:#111827;padding:18px;color:#ffffff;font-size:13px;">
          Copyright ${new Date().getFullYear()} Bigwig Media. All Rights Reserved.
        </td>
      </tr>
...
exports.verifyOTP = async (req, res) => {
  try {
    ...
    await sendEmail({
      to: email,
      subject: "Thank You for Contacting Bigwig Media",
      html: `
  <div style="margin:0;padding:40px 20px;background:#f4f7f9;font-family:Arial,Helvetica,sans-serif;">
    <table align="center" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e5e7eb;">
      ...
      <tr>
        <td style="padding:40px 35px;color:#333333;">
          ...
          <p style="margin:0 0 18px;font-size:16px;line-height:1.8;color:#4b5563;">
            Our team will review your enquiry and get in touch with you as soon as possible.
          </p>

          <p style="margin:0 0 30px;font-size:16px;line-height:1.8;color:#4b5563;">
            We appreciate your interest in Bigwig Media and look forward to helping your brand grow online.
          </p>
      ...
      <tr>
        <td style="padding:35px 35px 15px;">
          ...
          <p style="margin:10px 0 0;color:#6b7280;font-size:15px;">
            A new enquiry has been submitted through the Bigwig Media website.
          </p>
        </td>
      </tr>
